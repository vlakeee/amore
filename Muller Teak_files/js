...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_experimentKey":"GTM-P8DSZ42_OPT-56QS3",
      "function":"__c",
      "vtp_value":true
    },{
      "function":"__u",
      ...
      "function":"__exs",
      "vtp_measurementId":"kkCCj3VmS9KFXxbF9VSEBA",
      "vtp_sections":["list",2]
    },{
      "vtp_experimentKey":"GTM-P8DSZ42_OPT-56QS3",
      "function":"__c",
      ...
      "function":"__c",
      "vtp_value":["map","",18357,"kkCCj3VmS9KFXxbF9VSEBA",18416,"H3F4yXmDQV6UKQI1ytjnaw",18419]
    },{
      "function":"__gthc",
      "vtp_trackingId":"UA-74036703-1"
    },{
      ...
      "vtp_experimentKey":"GTM-P8DSZ42_OPT-MVK6K",
      "function":"__c",
      "vtp_value":true
    },{
      "function":"__u",
      ...
      "function":"__exs",
      "vtp_measurementId":"H3F4yXmDQV6UKQI1ytjnaw",
      "vtp_sections":["list",2]
    },{
      "vtp_experimentKey":"GTM-P8DSZ42_OPT-MVK6K",
      "function":"__c",
  ...
  "tags":[{
      ...
      "vtp_activate":true,
      "vtp_isEmpty":false,
      "vtp_treatmentId":"Experiment_GTM-P8DSZ42_OPT-56QS3:0",
      "vtp_contextIndex":0,
      "tag_id":32
    },{
      "function":"__exsu",
      ...
      "function":"__esc",
      "vtp_selector":"body.template-index",
      "vtp_identifier":"body.template-index",
      "vtp_script":"$('#SiteNavLabel-footwear-1 \u003E ul').append('\u003Cli\u003E\u003Ca class=\"site-nav__link site-nav__child-link site-nav__link--last h3\" href=\"\/pages\/find-my-footwear\"\u003EStyle Quiz\u003C\/a\u003E\u003C\/li\u003E');\n\n$('ul.mobile-nav__dropdown[data-parent=\"footwear-1\"] \u003E li:last-child').addClass('border-bottom');\n$('ul.mobile-nav__dropdown[data-parent=\"footwear-1\"]').append('\u003Cli class=\"mobile-nav__item\"\u003E\u003Ca href=\"\/pages\/find-my-footwear\" class=\"mobile-nav__sublist-link\"\u003EStyle Quiz\u003C\/a\u003E\u003C\/li\u003E');",
      ...
      "vtp_selector":"body.template-index",
      "vtp_identifier":"body.template-index",
      "vtp_script":"var checkExist = setInterval (function(){\n  if($('#Slideshow-1480392841169.slick-initialized').length){\n    pauseCarousel(false);\n    console.log('Paused Carousel');\n    clearInterval(checkExist);\n  }\n}, 100);\n\nfunction pauseCarousel(hold){\n      $('#Slideshow-1480392841169').slick('slickPause');\n      $('#Slideshow-1480392841169').slick(\"slickSetOption\", \"accessibility\", hold);\n      $('#Slideshow-1480392841169').slick(\"slickSetOption\", \"draggable\", hold);\n      $('#Slideshow-1480392841169').slick(\"slickSetOption\", \"swipe\", hold);\n      $('#Slideshow-1480392841169').slick(\"slickSetOption\", \"touchMove\", hold);\n}\n\n\n",
      ...
      "vtp_selector":"li.site-nav--has-dropdown:hover .site-nav__dropdown",
      "vtp_identifier":"body.template-index",
      ...
      "vtp_activate":true,
      "vtp_isEmpty":false,
      "vtp_treatmentId":"Experiment_GTM-P8DSZ42_OPT-MVK6K:0",
      "vtp_contextIndex":0,
      "tag_id":52
    },{
      "function":"__est",
      "teardown_tags":["list",["tag",13,0]],
      "vtp_selector":"#shopify-section-1553101196525",
      "vtp_identifier":"#shopify-section-1553101196525",
      ...
      "vtp_selector":"body #Slideshow-1480392841169 .slick-dots",
      "vtp_identifier":"body #Slideshow-1480392841169 .slick-dots",
      "vtp_property":"display",
      "vtp_value":"none",
      "vtp_cssRule":true,
      "vtp_important":true,
...
function Tc(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.o[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var Vc={},Wc=null,Xc=Math.random();Vc.s="GTM-P8DSZ42";Vc.Cb="3p1";var Yc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Zc="www.google-analytics.com/gtm.js";var $c=Zc,ad=null,bd=null,cd=null,ed="//www.googletagmanager.com/a?id="+Vc.s+"&cv=188",fd={},gd={},hd=function(){var a=Wc.sequence||0;Wc.sequence=a+1;return a};var id={},jd=function(a,b){id[a]=id[a]||[];id[a][b]=!0},kd=function(a){for(var b=[],c=id[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
...
var bh={"":"n",UA:"u",AW:"a",DC:"d",G:"e",GF:"f",HA:"h",GTM:$g,OPT:"o"},ch=function(a){var b=Vc.s.split("-"),c=b[0].toUpperCase(),d=bh[c]||"i",e=a&&"GTM"===c?b[1]:"OPT"===c?b[1]:"",f;if(3===Vc.Cb.length){var h=void 0;h=h||"z";f="2"+(h||"w")}else f=
...
var Vi={policy:!0};var Wi=function(a,b){var c=a.hide;if(c&&void 0!==c[b]&&c.end){c[b]=!1;var d=!0,e;for(e in c)if(c.hasOwnProperty(e)&&!0===c[e]){d=!1;break}d&&(c.end(),c.end=null)}},Yi=function(a){var b=Xi(),c=b&&b.hide;c&&c.end&&(c[a]=!0)};var Zi=!1,$i=[];function aj(){if(!Zi){Zi=!0;for(var a=0;a<$i.length;a++)I($i[a])}}var bj=function(a){Zi?I(a):$i.push(a)};
var kj=function(){try{var a,b;var c=F[Se()],d="";""==d&&(d="t0");b="ga";try{var e=c&&c.getByName&&c.getByName(d);if(e){0===d.indexOf("gtag_")&&(b="gtag");e.get("&gtm")&&(b="gtm");for(var f in c)if(c.hasOwnProperty(f)){var h=c[f];if("l"!=f&&"answer"!=f&&"number"==typeof h){var k=cj-h;1E5>k&&0<k&&(a=k)}}}}catch(z){console.log("[tick.ga] - "+Vc.s+": exception: "+z)}var l,m=Vc.s,n=wc('script[src*="gtm/js?id='+m+'"],script[src*="optimize.js?id='+m+'"]');l=n&&0<n.length?n[0]:null;b||(b="gaoo");var r=dj(ej,l&&l.src),u=r.pb,p=r.qb,t=r.$b,v=r.ac,w=r.Pb,y=r.jc,x=r.kb,B=r.Mc,A=r.jb;"h0"!=x||fj||(x="h3");gj={kb:x,jb:A,kg:a,Ig:b,Mc:B,ac:v,Pb:w,jc:y,$b:t,pb:u,qb:p,pe:ij};jj(gj)}catch(z){console.log("[opttick] - "+
Vc.s+": exception: "+z)}},lj=function(){var a=F.gaData,b=0;if(a)for(var c in a)a.hasOwnProperty(c)&&0===c.indexOf("UA-")&&a[c].hitcount&&(b+=a[c].hitcount);return b},dj=function(a,b){var c,d,e,f,h,k,l,m,n;var r=F.performance;if(r){var u=r.getEntries();if(b){var p=r.getEntriesByName(b)[0];u&&1<u.length&&p&&(f=Math.round(p.startTime-u[1].startTime),h=Math.round(p.duration),e=u.indexOf(p),-1===e&&(e=void 0),k=Math.round(a-(p.startTime+p.duration)))}var t=
r.timing;if(t.domContentLoadedEventStart){var v=t.domContentLoadedEventStart-t.navigationStart;v&&(d=Math.round(a-v))}var w=r.getEntriesByType("paint").filter(function(A){return"first-contentful-paint"===A.name})[0];w&&(c=Math.round(a-w.startTime))}var y=F["dataLayer"].hide;if(y){if(void 0===y[Vc.s])l="h2";else{var x=!1;if(null===y.end)for(var B in y)if(y.hasOwnProperty(B)&&B.startsWith(Vc.s)&&!0===y[B]){x=!0;break}l=x?"h0":"h1"}y.start&&!isNaN(y.start)&&(r?r.timing&&(n=Math.round(a+r.timing.navigationStart-
y.start)):n=a-y.start);isNaN(y.timeout)||(m=y.timeout)}return{pb:d,qb:c,$b:e,ac:f,Pb:h,jc:k,kb:l,Mc:m,jb:n}},jj=function(a,b){b=void 0===b?"ol":b;var c=function(e,f){null!=f&&(d+=e+encodeURIComponent(f))},d=ed;c("&t=",b);c("&s=",a.kb);c("&h=",a.jb);c("&g=",a.kg);c("&p=",a.Ig);c("&o=",a.Mc);c("&l=",ad?cj-za(ad):void 0);c("&q=",a.ac);c("&f=",a.Pb);c("&e=",a.jc);c("&i=",a.$b);c("&d=",a.pb);c("&c=",a.qb);c("&tr=",a.oh);c("&jl=",a.Gg);c("&jf=",
a.Eg);c("&ji=",a.Fg);c("&jq=",a.Hg);c("&jd=",a.Cg);c("&jx=",a.Dg);c("&hc=",a.pe);d+="&sr=0.050000";c("&ps=",mj);c("&cb=",wa());lc(d);},nj=!1,cj,ej,fj,mj,gj,ij;mj=Math.random(),nj="0.050000">mj;var pj=function(a){var b=oj;if(!nj)return;try{var c=dj(performance&&performance.now()||Ea(),b),d=Object.assign(gj||{},a,{kb:c.kb,jb:c.jb,pb:c.pb,qb:c.qb,Fg:c.$b,
Hg:c.ac,Cg:c.Pb,Dg:c.jc,pe:lj()});jj(d,"od")}catch(e){console.log("[odtick] - "+Vc.s+": exception: "+e)}};var rj=function(a){if(qj(a))return a;this.h=a};rj.prototype.pg=function(){return this.h};var qj=function(a){return!a||"object"!==Na(a)||Pa(a)?!1:"getUntrustedUpdateValue"in a};rj.prototype.getUntrustedUpdateValue=rj.prototype.pg;var sj=[],tj=!1,uj=function(a){return F["dataLayer"].push(a)},vj=function(a){var b=Wc["dataLayer"],c=b?b.subscribers:1,d=0;return function(){++d===c&&a()}};
function wj(a){var b=a._clear;C(a,function(f,h){"_clear"!==f&&(b&&Sd(f,void 0),Sd(f,h))});ad||(ad=a["gtm.start"]);a:{if(!nj||cj)break a;cj=Ea();ej=performance&&performance.now()||cj;fj=!!G.querySelector("body");ij=lj();bj(kj);}var c=a.event;if(!c)return!1;var d=a["gtm.uniqueEventId"];d||(d=hd(),a["gtm.uniqueEventId"]=d,Sd("gtm.uniqueEventId",d));cd=c;var e=xj(a);
...
b);return F[a]},tk=function(a,b,c){return Rf(a,b,void 0===c?!0:!!c)},uk=function(a,b){if(Wd()){b&&I(b)}else kc(a,b)},vk=function(a){return!!Jj(a,"init",!1)},wk=function(a){Hj(a,"init",!0)},xk=function(a,b){var c=(void 0===b?0:b)?"www.google-analytics.com/gtag/js":$c;c+="?id="+encodeURIComponent(a)+"&l=dataLayer";S(Q("https://","http://",c))},yk=function(a,b){var c=a[b];return c};
var zk=Cj.Jg;
var Ak=function(a){if(!a||a.nodeType!=Node.ELEMENT_NODE)return!1;var b=a.tagName.toUpperCase();return"SCRIPT"==b||"STYLE"==b||"LINK"==b},Bk=function(a,b,c){null==c?a.removeAttribute(b):a.setAttribute(b,c)},Ck=function(a,b,c){var d=a.getAttribute(b);Bk(a,b,c);return function(){Bk(a,b,d)}},Fk=function(a,b,c){var d,e,f=a.ownerDocument||a.document||document;c=(c||"").toLowerCase();"after"==c?(d=a.parentNode,e=a.nextSibling):"insert"==c?(d=a,e=a.firstChild):"append"==c?(d=a,e=null):(d=a.parentNode,e=a);
if(!d||d==f)return{result:1,xg:[]};var h=Dk(b,d);Ek(h,"SCRIPT");Ek(h,"NOSCRIPT");var k=[];if(h.firstChild)for(var l=h.firstChild;l;){var m=l.nextSibling;k.push(l);d.insertBefore(l,e);l=m}var n=a.nextSibling;"replace"==c&&d.removeChild(a);return{result:function(){for(;0<k.length;)d.removeChild(k.pop());"replace"==c&&d.insertBefore(a,n)},xg:k.slice()}},Gk={SELECT:[1,'<select multiple="multiple">',"</select>"],FIELDSET:[1,"<fieldset>","</fieldset>"],MAP:[1,"<map>","</map>"],OBJECT:[1,"<object>","</object>"],
TABLE:[1,"<table>","</table>"],TBODY:[2,"<table><tbody>","</tbody></table>"],COLGROUP:[2,"<table><colgroup>","</colgroup></table>"],TR:[3,"<table><tbody><tr>","</tr></tbody></table>"]},Dk=function(a,b){var c=0,d="",e="",f=Gk[b.tagName];null!=f&&(c=f[0],d=f[1],e=f[2]);var h=document.createElement("div");h.innerHTML=d+(a||"")+e;for(var k=h;0<c;){var l=k.firstChild;if(!(l instanceof Element))return document.createElement("div");k=l;c--}return k},Ek=function(a,b){for(var c=a.getElementsByTagName(b),d=
[],e=c.length-1;0<=e;e--){var f=c[e];f.parentNode.removeChild(f);d.push(f)}},Hk=function(a){var b=null,c=null;try{b=new Function("element",a)}catch(d){c=d}return{Jc:b,error:c}},Lk=function(a,b,c,d,e){var f=a+"{"+(b+": "+c+(d?" !important":""))+"}";e&&(f=e+"{"+f+"}");var h=document;if(h.createStyleSheet){var k=Ik(h),l=k.rules.length;k.insertRule(f,l);return function(){k.deleteRule?k.deleteRule(l):k.removeRule(l);k.insertRule("x {}",l)}}var m=Jk(f,h);Kk(m,h);var n=m.parentNode;return function(){n.removeChild(m)}},
Mk=null,Ik=function(a){if(Mk)return Mk;for(var b=a.styleSheets.length-1;0<=b;b--){var c=a.styleSheets[b],d=c.ownerNode;if(d&&d.parentNode&&"HEAD"==d.parentNode.tagName)return Mk=c}0==a.styleSheets.length&&a.createStyleSheet();return Mk=a.styleSheets[0]},Jk=function(a,b){var c=(b||document).createElement("style");void 0!==c.cssText?c.cssText=a:c.innerHTML=a;return c},Kk=function(a,b){var c=b||document,d=c.getElementsByTagName("head")[0];d||(d=c.createElement("head"),c.body.parentNode.insertBefore(d,
c.body));d.appendChild(a)},Nk=function(a,b,c,d){if(a.style.setProperty)try{var e=a.style.getPropertyValue(b),f=a.style.getPropertyPriority(b);a.style.setProperty(b,c,d?"important":"");return function(){a.style.setProperty(b,"",f);a.style.setProperty(b,e,f)}}catch(k){}var h=a.style.cssText;a.style.cssText+=";"+(b+": "+c+(d?" !important":""))+";";return function(){a.style.cssText=h}},Pk=function(a,b,c,d){if(Ak(a))return 7;if(b)return Ok(a,b,d);if(c&&c.parentNode){var e=a.parentNode,f=a.nextSibling;
c.parentNode.insertBefore(a,c.nextSibling);return function(){e.insertBefore(a,f)}}return 4},Ok=function(a,b,c){var d=a.parentNode,e=a.nextSibling;c=(c||"").toLowerCase();if("bottom"==c)b.appendChild(a);else if("top"==c)b.insertBefore(a,b.childNodes[0]||null);else if("before"==c)if(b.parentNode)b.parentNode.insertBefore(a,b);else return 5;else if("after"==c)if(b.parentNode)b.parentNode.insertBefore(a,b.nextSibling);else return 5;return function(){d.insertBefore(a,e)}},Qk=function(a,b,c){if(0<=b&&b<
a.childNodes.length){var d=a.childNodes[b];if(null!=d&&d.nodeType==Node.TEXT_NODE){var e=d.nodeValue;d.nodeValue=c;return function(){d.nodeValue=e}}return 2}return 3},Rk=function(a,b,c,d){c?d=c.nextSibling:d&&(c=d.previousSibling);if(null!=c&&c.nodeType==Node.TEXT_NODE){var e=c.nodeValue;c.nodeValue+=a;return function(){c.nodeValue=e}}if(null!=d&&d.nodeType==Node.TEXT_NODE){var f=d.nodeValue;d.nodeValue=a+d.nodeValue;return function(){d.nodeValue=f}}var h=(b.ownerDocument||b.document||document).createTextNode(a);
d?b.insertBefore(h,d):b.appendChild(h);return function(){b.removeChild(h)}},Sk=function(a){var b=document.createElement("a");a&&(b.href=a);return b};var Wk=new xa;function Xk(a,b){function c(h){var k=af(h),l=$e(k,"protocol"),m=$e(k,"host",!0),n=$e(k,"port"),r=$e(k,"path").toLowerCase().replace(/\/$/,"");if(void 0===l||"http"==l&&"80"==n||"https"==l&&"443"==n)l="web",n="default";return[l,m,n,r]}for(var d=c(String(a)),e=c(String(b)),f=0;f<d.length;f++)if(d[f]!==e[f])return!1;return!0}
...
var el=function(a,b,c){for(var d={},e=!1,f=0;a&&f<a.length;f++)a[f]&&a[f].hasOwnProperty(b)&&a[f].hasOwnProperty(c)&&(d[a[f][b]]=a[f][c],e=!0);return e?d:null};al.Ag=function(){var a=!1;return a};var hl=function(a){if(!fl[a]){fl[a]=!0;var b=F[a]||{};F[a]=b;var c=function(e){return gl[e]},d=b.get;b.get=d?function(e){return void 0!==gl[e]?gl[e]:d(e)}:c}},il=function(a,b,c){try{a(c,b)}catch(d){}},kl=function(a){jl[a]=jl[a]||[];return jl[a]},gl={},jl={},fl={};
var ll=function(a){F.gaData=F.gaData||{};var b=F.gaData,c=b.tracker_created;b.tracker_created=function(d){c&&pa(c)&&c(d);a(d)}},ml=function(a){var b=F[Se()];try{if(pa(b)&&pa(b.getAll))return va(b.getAll(),function(c){return c.get("trackingId")===a})}catch(c){console.log("Optimize: GA Exception "+c+" trackingId: "+a+" exception: "+c)}},sl=function(a,b){var c=nl[a];if(c)I(function(){return b(c)});else{var d=ml(a);d?(nl[a]=d,ol||(ol=d),I(function(){return b(d)})):(pl[a]||(pl[a]=[]),pl[a].push(b),ql||
(ql=!0,ll(function(e){var f=e.get("trackingId");if(pl[f]){if(rl[f]){rl[f]=!1;var h=F[Se()];pa(h)&&h("ga.require","_"+Vc.s)}ol||(ol=e);nl[f]=e;for(var k=pl[f],l;void 0!==(l=k.shift());)l(e);pl[f]=void 0}})))}},nl={},pl={},rl={},ol,ql=!1,tl=function(a,b){sl(a,function(c){var d=F[Se()];try{var e="t0"!=c.get("name")?c.get("name")+".send":"send";d(e,b)}catch(f){console.log("Optimize: failed to send hit using tracker: "+c.name+" exception "+f)}})};

var xl=function(a,b,c){function d(){f||(f=!0,!0!==ul&&(ul=!1),vl(c),Wi(Xi(),e))}oj=a;var e="GTM-P8DSZ42_"+b,f=!1;Yi(e);F.google_optimize=F.google_optimize||{};var h=F.google_optimize;h["GTM-P8DSZ42"]=h["GTM-P8DSZ42"]||{};h["GTM-P8DSZ42"].optimize_dyn=function(l){l.split(",").forEach(function(m){wl[m]=!0});ul=!0;d()};ic(a,void 0,d);var k=Xi();F.setTimeout(function(){d()},Number(k&&k.hide&&k.hide.timeout)||1E4)},vl=function(a){if(void 0!==yl){var b=yl-zl,c,d;ul?c=Ea()-yl:d=Ea()-yl;pj({oh:b,Gg:c,Eg:d})}wl.optimize_ready=
!0;uj({event:"opt.dyn"});uj({event:"opt.js"});if(a&&0<a.length){var e={};Xi().forEach(function(f){var h=f.event;h&&(e[h]=!0)});a.forEach(function(f){e[f]&&uj({event:f})})}I(function(){Te("_"+Vc.s)})},Xi=function(){return F["dataLayer"]},Al=function(a,b,c,d,e,f,h){function k(p,t){t&&(r+="&"+p+"="+encodeURIComponent(t))}zl=Ea();if(a||b||c){var l=void 0;if(b){var m=Og().aw;m&&(l=m[0])}if(f&&(a||c||l)){var n=1,r,u="GTM-P8DSZ42_"+n++;Yi(u);rl[d]=!0;sl(d,function(p){yl=Ea();a||b?(r="?id=GTM-P8DSZ42",
a&&k("cid",p.get("clientId")),k("gclid",l),h&&(k("gtm_auth",""),k("gtm_preview","")),(h||a)&&k("cb",String(Math.random())),xl(r,n++,e)):vl(e);Wi(Xi(),u)})}else vl(e)}},wl={},zl,yl,ul,oj;var Bl=function(a,b){this.Mb=a;this.nb=b};Bl.prototype.toString=function(){var a=""+this.Mb;1<this.nb&&(a=a+"-"+this.nb);return a};var Cl=function(a,b){this.i=a;this.h=b};Cl.prototype.toString=function(){return this.h+"."+this.i};
var Dl=function(){var a=Md("optimize.cookie_path",2);return g(a)?a:"/"},Fl=function(a,b){var c=new El(a,b);c.Pg();return c},El=function(a,b){this.R=Math.floor(new Date/864E5);this.i=a||"auto";this.h=b||Dl();this.m=new Bl(nh(this.i),oh(this.h));this.o=[];this.map={}};aa=El.prototype;aa.og=function(a){if(!a)return"";var b=this.Kc(a);return b?b.i:""};aa.gh=function(a,b,c,d,e){var f,h;f=void 0===f?10:f;h=void 0===h?3E3:h;if(!a)return!1;void 0==b&&(b="");this.hc(a,new Cl(b,c));this.Hf(e);return this.Kg(d,
f,h)};aa.Kc=function(a){return this.map[a]};aa.ng=function(){for(var a=0,b=0;b<this.o.length;b++)"x"!==this.Kc(this.o[b]).i[0]&&a++;return a};aa.hc=function(a,b){a&&(""===b.i?this.He(a):(this.map[a]||this.o.push(a),this.map[a]=b))};aa.jh=function(a){for(var b=0;b<a.length;b++)this.hc(a[b][0],a[b][1])};aa.He=function(a){var b=q(this.o,a);0<=b&&this.o.splice(b,1);delete this.map[a]};aa.Yg=function(){for(var a=[],b=0;b<this.o.length;b++){var c=this.o[b];this.map[c].h<this.R&&a.push(c)}for(var d=0;d<
a.length;d++)this.He(a[d])};aa.mg=function(){for(var a=[],b=0;b<this.o.length;b++){var c=this.o[b];a.push([c,this.map[c]])}return a};aa.eg=function(){for(var a=0,b=0;b<this.o.length;b++)a=Math.max(a,this.map[this.o[b]].h);return 864E5*a};aa.toString=function(){if(0==this.o.length)return"";for(var a=[],b=0;b<this.o.length;b++){var c=this.o[b];a.push(c+"."+this.map[c].toString())}return"GAX1."+this.m.toString()+"."+a.join("!")};aa.Kg=function(a,b,c){var d=new Date;this.Yg();var e=this.ng();if(e>b||
e>(a||10)&&document.cookie.replace(/(?:;\s*)?(_gaexp=[^;]+)(?:;\s*)?/,this.toString()).length>c)return!1;d.setTime(this.eg());if("auto"!=this.i)return this.m=new Bl(nh(this.i),oh(this.h)),$f("_gaexp",this.toString(),this.h,this.i,d);for(var f=Xf(),h=0;h<f.length;h++)if(this.m=new Bl(nh(f[h]),oh(this.h)),$f("_gaexp",this.toString(),this.h,f[h],d))return!0;return!1};aa.Pg=function(){var a=Uf("_gaexp",this.m.Mb,this.m.nb);if(a){var b=this.Qg(a);b&&this.jh(b.mg())}};aa.Qg=function(a){for(var b=new El(this.i,
this.h),c=a.split("!"),d=0;d<c.length;d++){var e=c[d].split(".");if(3==e.length){if(isNaN(Number(e[1])))return;b.hc(e[0],new Cl(e[2],Number(e[1])))}}return b};aa.Hf=function(a){a=a||{};var b=0;a.hasOwnProperty("")&&!isNaN(Number(a[""]))&&(b=this.R-za(a[""]));for(var c=0;c<this.o.length;c++){var d=this.o[c];if(a.hasOwnProperty(d)&&!isNaN(Number(a[d]))){var e=this.Kc(d);e.h=za(a[d])+b;this.hc(d,e)}}};
var Gl=function(a){if(ve)return!0;for(;a;){if(a.nextSibling)return!0;a=a.parentNode}return!1},Hl=function(a,b){for(var c=wc(a.H)||[],d=[],e=0;e<c.length;e++){var f=c[e];if(!f.gtmProgressiveApplied||!f.gtmProgressiveApplied[b]){if(a.T&&!Gl(f))break;d.push(f)}}return d},Il=function(a,b){return function(){a.gtmProgressiveApplied&&delete a.gtmProgressiveApplied[b]}},Jl=function(a,b){a.gtmProgressiveApplied||(a.gtmProgressiveApplied={});a.gtmProgressiveApplied[b]=!0},Kl=function(a,b){var c=[];if(b.ba){var d=
Hl(b.ba,b.id),e=null;b.ic&&(e=Hl(b.ic,b.id+"-t"));for(var f=0;f<d.length;f++){var h=d[f],k=void 0;if(null!=e&&(k=e.length>f?e[f]:null,!k&&!ve&&(null===b.ic.D||b.de+c.length<b.ic.D)))break;c.push({element:h,mh:k})}}if(!ve&&b.Bf&&(!a||null==b.ba.D||b.ba.D!=b.Fc+c.length))return!1;for(var l=0;l<c.length;l++){var m=c[l].element,n=c[l].mh,r=void 0;b.Fc++;Jl(m,b.id);n&&(b.de++,r=b.id+"-t",Jl(n,r));var u=b.If(m,n);pa(u)&&b.Oa.push(u);b.Oa.push(Il(m,b.id));n&&r&&b.Oa.push(Il(n,r))}if(b.ba.D&&b.ba.D==b.Fc||
ve)b.finished=!0;return!0},Ll=function(a){for(var b={},c=0;c<a.V.length;c++){var d=a.V[c];if(d.ba){var e=b[d.ba.H];e||(e=b[d.ba.H]=wc(d.ba.H)||[]);for(var f=0;f<e.length;f++){var h=e[f];h.gtmProgressiveApplied&&h.gtmProgressiveApplied[d.id]||(Jl(h,d.id),d.Oa.push(Il(h,d.id)))}}}},Ml=function(a){if(!a.dd){for(var b=a.ib;b<a.V.length;b++){var c=a.V[b],d=b==a.ib;if(!c.finished&&!Kl(d,c))break;c.finished&&d&&a.ib++}a.V.length>a.ib?(a.la||(a.la=F.setTimeout(function(){a.la=null;Ml(a)},80)),ve||a.Wc||(a.Wc=
function(){I(function(){Ml(a)})},mc(G,"DOMContentLoaded",a.Wc))):Ll(a)}},Nl={},Ol={},Pl=void 0,Ql=function(a,b,c,d){var e=Pl;if(!vc||!e)return!1;var f={id:e.id+":"+e.V.length,If:b,Oa:[],Bf:c,ba:a,Fc:0,ic:d||null,de:0,finished:!1};e.V.push(f);null===a?(f.finished=!0,b(null)):Ml(e);return!0},Rl=function(a){var b=Lk(a,"visibility","hidden",!0);return function(){pa(b)&&b.apply();b=null}},Sl=function(a,b,c,d){var e=b;if(!ve){var f=Rl(a.H);xe.push(f);e=function(h,k){var l=b(h,k);f();return l}}return Ql(a,
e,c,d)};var rm=function(){var a=F.gaGlobal=F.gaGlobal||{};a.hid=a.hid||wa();return a.hid};var Cm=window,Dm=document,Em=function(a){var b=Cm._gaUserPrefs;if(b&&b.ioo&&b.ioo()||a&&!0===Cm["ga-disable-"+a])return!0;try{var c=Cm.external;if(c&&c._gaUserPrefs&&"oo"==c._gaUserPrefs)return!0}catch(f){}for(var d=Rf("AMP_TOKEN",Dm.cookie,!0),e=0;e<d.length;e++)if("$OPT_OUT"==d[e])return!0;return Dm.getElementById("__gaOptOutExtension")?!0:!1};var Hm=function(a){C(a,function(c){"_"===c.charAt(0)&&delete a[c]});var b=a[J.ca]||{};C(b,function(c){"_"===c.charAt(0)&&delete b[c]})};var Lm=function(a,b,c){Ai(b,c,a)},Mm=function(a,b,c){Ai(b,c,a,!0)},Om=function(a,b){};
function Nm(a,b){}var Z={a:{}};Z.a.dee=["google"],function(){(function(a){Z.__dee=a;Z.__dee.b="dee";Z.__dee.g=!0;Z.__dee.priorityOverride=0})(function(){var a=!1;return a?"gtm.sync":"gtm.js"})}();

Z.a.exs=["google"],function(){(function(a){Z.__exs=a;Z.__exs.b="exs";Z.__exs.g=!0;Z.__exs.priorityOverride=0})(function(a){var b=Fl(a.vtp_cookieDomain,a.vtp_cookiePath).og(a.vtp_measurementId);if(""===b)return b;if("x"===b[0]){var c=Number(b.substring(1));if("x"===b||isNaN(c)||0>c||1E3<=c)return""}else{var d=a.vtp_sections;if(d){var e=b.split("-");if(d.length!=e.length)return"";for(var f=0;f<d.length;f++)if(0>e[f]||e[f]>=d[f])return""}}return b})}();
Z.a.optua=["google"],function(){(function(a){Z.__optua=a;Z.__optua.b="optua";Z.__optua.g=!0;Z.__optua.priorityOverride=0})(function(a){tl(a.vtp_trackingId,a.vtp_hitParams);a.vtp_gtmOnSuccess()})}();
...
Z.a.exsu=["google"],function(){(function(a){Z.__exsu=a;Z.__exsu.b="exsu";Z.__exsu.g=!0;Z.__exsu.priorityOverride=0})(function(a){Fl(a.vtp_cookieDomain,a.vtp_cookiePath).gh(a.vtp_measurementId,a.vtp_newState,a.vtp_expirationDay,a.vtp_max,a.vtp_expirationDates)?a.vtp_gtmOnSuccess():a.vtp_gtmOnFailure()})}();
Z.a.ctto=["google"],function(){(function(a){Z.__ctto=a;Z.__ctto.b="ctto";Z.__ctto.g=!0;Z.__ctto.priorityOverride=0})(function(a){var b=a.vtp_isDynamic,c=X("dataLayer"),d=c&&c.hide;if(!d)return!1;var e=Vc.s,f=X("document");if(void 0===f.querySelector)return!1;var h=!!f.querySelector("body");if(null!==d.end||!h)return!1;if(!b)return!0===d[e];for(var k in d)if(d.hasOwnProperty(k)&&k.startsWith(e)&&!0===d[k])return!0;return!1})}();
Z.a.dr=["google"],function(){(function(a){Z.__dr=a;Z.__dr.b="dr";Z.__dr.g=!0;Z.__dr.priorityOverride=0})(function(a){var b=a.vtp_treatmentId,c=a.vtp_activate,d=a.vtp_contentSignature,e=a.vtp_isEmpty,f=U("optimize.experimentCallback",1),h=a.vtp_measurementId,k=a.vtp_experimentCombination,l;if(l=c){var m=Nl[h];l=!(!m||m==b)}if(l)a.vtp_gtmOnFailure();else{var n=U("optimize.whitelist",1);if(n&&n[h]?n[h]===d:pe()?e:1){if(pa(f)){var r={xid:h,xvar:k,activate:c};try{f(r)}catch(R){}}var u=!1,p=!0;if(c){var t;
Nl[h]=b;var v=Ol[b];if(v){for(var w=v.ib=0;w<v.V.length;w++)v.V[w].finished=!1;Ml(v);t=!0}else t=!1;if(t)u=!0;else{var y=Ol[b];y||(y={id:b,V:[],ib:0,la:null,Wc:void 0,dd:!1},Ol[b]=y);Pl=y}}else{var x=Ol[b];if(!x||x.dd)p=!1;else{for(;x.V.length;)for(var B=x.V.pop();B.Oa.length;){var A=B.Oa.pop();if(pa(A))try{A()}catch(R){}}x.dd=!0;delete Ol[b];p=!0}}if(p){var z=c?k:void 0;gl[h]=z;for(var E=kl(h),H=0;H<E.length;H++)il(E[H],h,z);E=kl("");for(var K=0;K<E.length;K++)il(E[K],h,z)}a[u?"vtp_gtmOnFailure":
...
Z.a.asprv=["google"],function(){(function(a){Z.__asprv=a;Z.__asprv.b="asprv";Z.__asprv.g=!0;Z.__asprv.priorityOverride=0})(function(a){var b=a.vtp_globalName,c=U("eventModel");b&&hl(b);var d,e,f;c&&(d=c.name||"",e=c.callback,f=c.remove);if(e&&pa(e))if(d=String(d),!0!==f){var h=d,k=e;kl(h).push(k);if(""!==h)void 0!==gl[h]&&il(k,h,gl[h]);else for(var l in gl)void 0!==gl[l]&&il(k,l,gl[l])}else{var m=e,n=kl(d),r=n.indexOf(m);0<=r&&n.splice(r,1)}a.vtp_gtmOnSuccess()})}();
